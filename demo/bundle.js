...
(() => {
  ...
  // src/components/newsPanel/index.tsx
  ...
  function NewsPanel({
    ...
    const [items, setItems] = (0, import_react.useState)(loadCache);
    const [conn, setConn] = (0, import_react.useState)("connecting");
    const seenIds = (0, import_react.useRef)(new Set(loadCache().map((i) => String(i.id))));
    const wsRef = (0, import_react.useRef)(null);
    const stopped = (0, import_react.useRef)(false);
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(
      "div",
      {
        ...
        children: [
          ...
          items.length === 0 && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { style: { fontSize: 13, opacity: 0.5 }, children: "Waiting for market news\u2026" }),
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { style: { maxHeight: 320, overflowY: "auto" }, children: items.map((item) => {
              ...
              "div",
              {
                ...
                children: [
                  /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { style: { display: "flex", alignItems: "baseline", gap: 8 }, children: [
                    ...
                    /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { style: { fontSize: 13, fontWeight: 600, lineHeight: 1.35 }, children: item.signal })
                  ] }),
                  item.short_context && /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
                    "div",
                    {
                      style: {
                        fontSize: 12,
                  ...
                  /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(
                    "div",
                    {
                      ...
                      children: [
                        tokens.map((t) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(
                          "a",
                          {
                            href: perpPath(t),
                            style: {
                        ...
                        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { style: { fontSize: 11, opacity: 0.4, marginLeft: "auto" }, children: timeAgo(Number(item.timestamp)) })
                      ]
                    }
                  )
                ]
  ...
  // demo/token.ts
  var GLORIA_TOKEN = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIweDBGQzY1ZDcxRDJmQ2JCNWMyMjAwMzMzMWUwNDZBOGZmOEYzODREMjEiLCJyb2xlcyI6WyJ1c2VyIl0sImFsbG93ZWRfZmVlZF9jYXRlZ29yaWVzIjpbInBlcnBzIiwiZGVmaSIsInRva2VuX2xpc3RpbmdzIiwiaHlwZXJsaXF1aWQiXSwiZXhwIjo0MzcwMjQ5MDA5LCJpYXQiOjE3NzgyNDkwMDl9.c6zxeptrA3lt6_ulZI-uNT5PshLRbbG9hyC0H0r9jM8";
